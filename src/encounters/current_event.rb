class Encounters::CurrentEvent < Encounter
  require_relative 'animal_herd'
  ...
  def table
    ...
    7.times { table << "#{ Encounters::AnimalHerd.roll } напали на женщину и ребенка" }
    ...
    10.times { table << "#{ Encounters::AnimalHerd.roll } доедают метрвое тело" }
